...
The scores should reflect the direct importance and relevance of the paper to each CCS concept:
...
if __name__ == "__main__":
    ...
    for i, info in enumerate(infos):
        ...
        with open(f"./{i}_acm/prompt.txt", "w") as f:
            f.write(generated_prompt)


        print(f"Saved prompt {i} to prompts/{i}_acm/prompt")
