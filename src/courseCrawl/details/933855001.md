...
**E. Grading Policy**
  1. Case summary, discussion & participation 20% (Lin) 
  2. Term Project (Each student needs to write a real SME case/report) 30%(Lin)
  3. Company background presentation (Group score) 10%(Chang)
  4. One-page feedback report for each company visit (total 6) 30%(Chang) 
  5. Company visit attendance and participation 10%(Chang)


##  指定/參考書目Textbook & References
  1. Textbook: not required. Students need to purchase one management case, one new case is free
  2. Recommended Books: any SME management textbook, Harvard Business Review
...
###  課程附件Course Attachments
  * 2025/07/16 20250716 Sept_Syllabus_SME final.pdf  收合 


###  課程進行中，使用智慧型手機、平板等隨身設備 To Use Smart Devices During the Class
需經教師同意始得使用  Approval
###  授課教師Office Hours及地點Office Hours & Office Location
  1. ****Class meetings:****19:10 – 22:00 Thursdays; Company visits: daytime on Thursdays****
  2. ****Instructor:****  
**Prof. Carol Yeh-Yun Lin Office hour: by appointment**  
****E-mail:yehyunln@nccu.edu.tw****  
  
****E-mail:chang.tawei@gmail.com****  
****Office Hours:****  
**Prof. Carol Lin –by appointment, 6F Commerce Building**  
**Prof. Chang: by appointment, meeting place to be arranged**
