...
有條件開放使用:AI is only permitted for proofreading purposes. If any student wishes to use AI beyond that, it must be explicitly discussed with the professor beforehand. Conditional Permitted to Use 
