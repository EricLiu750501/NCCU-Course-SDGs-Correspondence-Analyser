...
Usage of adverbđừng／chớ.
  1. Nhờ…mà 「由於。。。所以」的結構。
Structure: nhớ…mà “because…so that…” | 
  * 隨堂考試In-class Quiz:
辨認純越語、漢越詞、藉詞或混合詞等詞彙類型不同處Distinguish types of vocabulary which are pure Vietnamese or Sino-Vietnamese or loanwords or mixed words.
  * 回家作業 Homework:
  1. 依據詞彙及句型phương pháp, gạt bỏ, không tránh khỏi, ra, thấy, đừng, nhờ…mà… 造句 Make sentences based on words, phrase and sentence patterns.
