...
_課程要求_
上課參與討論、口頭報告、研究評論、小作業、期末報告與評論
_評分標準_
1.上課出席、參與討論 (10%）：視參與的質與量給分，若本學期均 _未主動_ 發言，本項成績為不及格。
2.研究評論與小作業(40%)
A.研究評論： _於該週上課前繳交紙本，逾期不候_ ，針對上課所閱讀的研究文獻，任選8篇有標●或★的作評論（每星期最多一篇，且每個同學最多只能針對2篇中文文獻作評論），字數大約1500-2000字， _主要針對研究方法的部分作評論，且特別著重在當週所談的主題上，譬如，如果當週主題談測量，那麼，「測量」就是你最應該著重的，請注意對於論文的摘要不要超過篇幅的三分之一，留下較多的篇幅進行你的反思、討論、學習與評論_ 。
a. 標●者：是很完整的一篇研究論文，請留意研究問題、理論與假設（若無，則說明其主要論述）、研究設計與蒐集資料方法（特別多著墨在當週主題）、研究發現是否驗證或否證研究結果、研究的優點與缺點，以及其他你想說的問題）。
b. 標★者：大多並非很完整的論文，而是書或論文的一部份，請針對當週的主題，說明你的反思、討論、學習與評論。
_請於_ _10_ _月底以前至少繳交_ _4_ _篇研究評論。_
_B.__小作業：針對若干主題作的練習，除了某幾週特別請你繳交紙本之外，其餘週會指定幾位同學進行口頭報告，主要針對每個星期我要你預先準備與思考的問題。_
3.期末報告 (50%)
A.一篇完整的研究設計(40%):使用 _上課所學習的研究方法_ 作一個完整的研究設計，不需要實際執行，但需要很具體可行。在期中確定題目，期末提書面與口頭報告，由同學與老師評論。評分標準除了以你研究設計的好壞作評估外，也看你 _是否能夠將課堂上所學的加以靈活運用_ 。至遲到11/6一定要確定期末報告主題，你對你的研究報告的主題有疑問的，可以來與老師討論，** _本學期請最少安排兩次與老師討論你的研究。_**
B.評論其他同學的研究報告(10%):能夠看出其他同學研究設計的優缺點，可以看出你的學習成效，因此這部分也列入成績的一部份。
##  指定/參考書目Textbook & References
Neuman, W. Lawrence. 2014. _Social Research Methods: Qualitative and Quantitative Approaches_. 7th ed. New York: Pearson. （雙葉書局代售，必備）
De Vaus, David. 2001. _Research Design in Social Research_. London: Sage. 
上述主要參考書籍外，並有若干相關的書籍與論文範例。
####  已申請之圖書館指定參考書目  圖書館指定參考書查詢 |相關處理要點
維護智慧財產權，務必使用正版書籍。 Respect Copyright.
##  本課程可否使用生成式AI工具Course Policies on the Use of Generative AI Tools
有條件開放使用:進行期末報告時，僅在文獻檢閱部分可利用AI進行文獻初步尋找，在研究設計上，必須是原創，不得使用AI Conditional Permitted to Use 
