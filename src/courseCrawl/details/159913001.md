...
**課程要求 :** 每位學生在期末必須繳交一篇書面的學期報告。第4-5週期間先選定報告題目；*_到了期中 ( 約7-8週_ _期間_ _)__，_ _先繳上這篇學期報告的計劃書 (proposal_ _，_ _須以英文撰寫_ _，大_ _約3 頁)__，並在課堂上進行約20 分鐘的口頭報告 (可用中文)_；學期結束後一週內，則繳上完成的書面學期報告(可用中文撰寫)，並進行口頭報告。
