...
Students are encouraged to come prepared for class and actively participate in discussions. I reserve the right to adjust grades by more than 20% in the case of extraordinary performance, either exceptionally good or bad. If you anticipate being absent from class, please inform me in advance.
2. Final presentation and paper（60%）
The final presentation and paper are crucial for evaluation. The paper should adhere to standard rules. Students have the freedom to select any case related to Anglo-American insurance law, and they are not limited to the cases covered in the course materials or textbooks. Your task is to summarize and provide a professional analysis of the chosen case. The schedule for oral presentations of students' case comments will be determined during our first meeting. The final paper should be submitted within one week after the end of this semester. The expected length of the paper is not less than 3,000 words, excluding footnotes and references.
##  指定/參考書目Textbook & References
Tom Baker, Kyle D. Logue, Carolyn V. Williams, Insurance Law & Policy: Cases Materials & Problems, 5th Ed., 2021.
