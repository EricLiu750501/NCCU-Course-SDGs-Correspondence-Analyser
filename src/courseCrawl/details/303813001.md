...
期末分組簡報60%；平時成績(課程參與、分組研討表現等)40%
##  指定/參考書目Textbook & References
N/A
####  已申請之圖書館指定參考書目  圖書館指定參考書查詢 |相關處理要點
維護智慧財產權，務必使用正版書籍。 Respect Copyright.
##  本課程可否使用生成式AI工具Course Policies on the Use of Generative AI Tools
有條件開放使用:不可將機敏資料或個人資料上傳至生成式AI； 如運用於程式或報告，需經分組成員共同討論、審視，並調校為具專業品質的成果。 Conditional Permitted to Use 
...
授課老師為兼任教師，同學可於實體授課時間的課間空檔與老師討論。
