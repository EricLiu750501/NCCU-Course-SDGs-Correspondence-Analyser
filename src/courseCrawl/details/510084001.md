...
|  2 |  3  
15 |  **BÀI VĂN TRANH LUẬN****議論文** **Argumentative essay** | 
  * Discussion on homework
  * **Từ mới** 生詞Vocabulary
  * **Giải thích ngữ pháp** 文法與詞彙的解釋Grammar and Usage
  * **Điền từ vào chỗ trống**
...
學生需於課前將詞彙記熟，文法與閱讀複習，以便於課堂上進行討論與練習。課堂作業繳交將以寄送 Moodle方式交予講師。最終成績將依以下四個部分判定:
Students are responsible for memorizing vocabulary, reviewing grammar, and reading materials before class in order to reserve valuable in-class time for discussion. All assignments are submitted in Moodle prior to the deadlines. The final grades are determined by 4 parts as follows:
  1. 出席率與參與度(討論，課堂活動，截止日期) Attendance and participation (discussion, in-class activities, meeting deadlines): **20** %
  2. 每週作業Weekly homework : **40** %
  3. 期中考試Midterm Exam : **20** %
  4. 總結報告 Final report: **20%**
