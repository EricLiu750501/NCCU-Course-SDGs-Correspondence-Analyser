...
評分標準
  1. 課程參與 20%
  2. 期中報告 30% ( 包括書面報告、發表競賽、團隊成員互評)
  3. 期末報告 50% ( 包括書面報告、發表競賽、團隊成員互評)


一、期中報告：品牌的社群經營計畫
提案內容是針對品牌進行健檢，並依照檢查結果提出社群改善方案、條列經營方向
期末報告:
正式的社群經營計畫書。
...
```
本課程不開放線上選修，欲選修同學請填寫申請表。另外，由於本課程申請企管系和供應鏈學程經費補助，且預計113學年度下學期續開此課程，故加簽將以傳播學院、企管系大四、碩二，供應鏈學程及創新創業學程、碩二優先，其他系所大四、碩二等次優先，若仍有名額再開放其他年級依上述排序加簽。
```
