...
週次 |  日期 |  主題 |  授課老師  
---|---|---|---  
1 |  09/01(一) |  09：10～11：00 **課程介紹、****Moodle****介紹、自我介紹、選出班代** 11：10～12：00 **聯合導生課** |  林義鈞老師 國發所老師  
...
16 |  12/15(一) |  1. 學期報告口頭發表 2. 學期報告上傳Moodle期限為： 2025年12月15日晚上11:59pm 3. 期末報告上傳Moodle內容為： **Turnitin****比對結果****(****首頁****) +****學期報告****內容** 不符合上述期限與內容規定者，0分計算 |  林義鈞老師  
...
1. 出席與參與（20%）：同學須準時上下課，每次上課前（9:00-9:10）於課程助理處簽到，下課後簽退。此項成績由課程導師評定，取決於同學出席情況、課堂參與表現（如發言、提問）。
  * 請假規則：如需請假，須於前一週週五中午12:00 之前以正式假單向課程導師請假，請假以2次為限。  
2. 每週作業─閱讀心得（30%）：同學須就每週指定教材撰寫1,000-1,500 字閱讀心得（含提問問題），並於前一週的週五中午12:00 之前上傳至課程線上平臺，檔案名稱一律規定為：姓名_課程週序，例如：艾國發_W1，此項成績由該週授課教師評定。
  * 學術引用格式：每週作業需至少引用1篇文獻，並遵守APA學術引用格式。
  * 每次作業滿分為100分，遲交一天之內扣當次成績5分，遲交兩天扣10分，依此類推。  
3. 學期報告─政大發展、國家發展或國際發展專案報告（50%）：同學須規畫一項政大發展、國家發展或國際發展專案，製作編寫一份專案報告簡報檔，於第9週提報專案主題，於第16週口頭發表，並於當天（2025年12月15日晚上23:59）上繳一份約12,000字的專案報告，基本架構如下：
  * 首頁需檢附整份學期報告的Turnitin比對結果
  * 其次為計畫前期研究：針對擬介入校園、國家或國際等議題進行前期研究，字數以7000字為限，回顧所選議題相關的現有學術文獻，評述現有學術發現與所擬實務專案的連結，及政大或該國經濟/社會/政策現況、利益相關人（部門/組織/個體）表現等。
  * 第三為計畫書，字數以3000字為限，撰寫模板如下：  
1. 計畫名稱：  
2. 計畫領域：（校園議題、農業、公衛醫療、教育、資通訊、環境、中小企業等）  
3. 執行地點：（校園/國家/地區）  
4. 預計執行單位：  
5. 現況說明：（內容應包含政大校務、國家政策、相關議題之現況及與永續發展目標之扣連）  
6. 計畫內容及執行方式說明：（內容應包含執行程序、執行上可能的挑戰與因應方式）  
7. 預期成果
  * 最後為參考文獻：學期報告須遵守學術倫理，包含首頁的**檢附****Turnitin****比對結果** ，以及報告內容的參考文獻**須遵守****APA****學術引用格式** ，依循美國心理學會出版手冊：**論文寫作格式第七版** （Publication Manual of the American Psychological Association, 7th Edition）為準則，撰寫學期報告、引用格式與參考文獻，建議參考《問題與研究》體例（https://wenti.nccu.edu.tw/upload/922c26fe-b014-4d51-835b-7da87174bd74.pdf）。
