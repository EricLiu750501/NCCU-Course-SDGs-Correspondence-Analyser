...
學習活動：50 %，根據對個案企業智慧財產之辨識狀況，每堂的分組討論活動投入程度。
期末書面報告：50 %，根據報告寫作技巧、問題的選擇、與討論的深度。
額外加分：上課發問（個人）；根據書面報告研究中與老師的互動（團體）。
...
禁止使用:不能用AI Prohibited Uses
###  課程相關連結Course Related Links
* * *
###  課程附件Course Attachments
  * 2025/06/07 Syllabus_MBA_IP Management and Practice_2025.pdf  收合 
