...
有條件開放使用:禁止使用：本課程禁止使用AI工具生成作業或報告，所有作業或報告必須為原創寫作，違者以零分計算。 但書寫過程，將AI工具生成的資料視為參考性資料輔助閱讀理解，原則上不限制，但禁止使用來路不明的資料。 Conditional Permitted to Use 
...
傳404，每周二下午1400-1700。傳院404室（請先來信預約）
