...
**【本課程份量重，****每週除 _上課時間_**** _3_**** _小時_****外****，另需**** _預留_**** _3_**** _小時_****自習及小組討論。小組討論的品質會影響課程進行及小組學期成績****，故請重視小組討論的效率及效果。】**
...
# 超商剩食大戰
(政大商管個案: 13-AC-04)  
13 |  11/25 |  新興行銷趨勢探討 **(****影響者行銷、****AI****協作行銷****)**  
14 |  12/2 |  **期末報告** |  **必須出席**  
...
* 教學進度可能視情況調整。  
  ...
  3. 每週出席是修習本課程的**義務** ，課程中主動發言是同學的**權利** ；**每缺席一次扣學期總分****1.5****分，** _完整出席但不曾發言討論，上課參與的分數最多得到_ _15_ _分_ 。
  4. 請同學依照課程進度，事先預習指定教材，課程進行以討論為主（授課為輔）； _隨時可能抽考預習內容_ 。逢個案討論的週次，請務必在上課前**熟讀個案並經過小組討論** ，並 _請各組於**每週一的中午**_** _12:00_**** _前_** _，將小組討論答案摘要_ _**(**_**_限_**** _2_**** _頁_**** _A_**** _4_**** _以內_**** _)_**_上傳至數位平台，**逾時概不受理** 。_
...
**Grading Policy**
Weekly Group Assignment (Case Discussion) 30%
Class Participation (+ Quiz & Peer Review) 20%
Mid-Term project presentation and reports 10%
Term project presentation and reports 20%
_Final exam 20%_
Total _100%_
##  指定/參考書目Textbook & References
  1. Cases 
  2. Textbook: Philip Kotler and Gary Armstrong (2024), _Principle of Marketing,_ 19th Edition, Pearson Education.


####  已申請之圖書館指定參考書目  圖書館指定參考書查詢 |相關處理要點
維護智慧財產權，務必使用正版書籍。 Respect Copyright.
##  本課程可否使用生成式AI工具Course Policies on the Use of Generative AI Tools
有條件開放使用:上課中經老師同意後可使用。作業若使用AI協助完成，需明確指出AI協助之範圍。 Conditional Permitted to Use 
...
###  課程附件Course Attachments
  * 2025/07/15 MBA_Syllabus 114_July.pdf  收合 


###  課程進行中，使用智慧型手機、平板等隨身設備 To Use Smart Devices During the Class
需經教師同意始得使用  Approval
###  授課教師Office Hours及地點Office Hours & Office Location
**Instructor: Dr. Peiyu Pai (****白佩玉****)**
**Office: Room 261109, 11th Fl., Commerce Bldg.**
**E-mail: p.pai@nccu.edu.tw**
** Phone: (02) 2939-3091 ext. 81109 **
