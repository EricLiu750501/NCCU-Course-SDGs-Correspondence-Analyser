...
基本技能測驗 |  1 |  5% |  低手傳接球 |  30整(A)+ 25~29次(A) 20~24次(A-) 15~19次(B+) 10~14次(B) 5 ~9 次(B-)  
基本技能測驗 |  1 |  10% |  攻防扣接 |  5次整(A+) 4次(A) 3次(B+) 2次(B) 1次(C +)  
期中考 |  1 |  20% |  發球技能測驗 |  九宮格(依照前、中、後排位置不同給予不同配分標準)  
期末考 |  1 |  25% |  攻擊及舉球配合 |  過網5次(A+) 過網4次(A) 過網3次(B+) 過網2次(B) 過網1次(C+) 皆未過網但具有攻擊助跑概念(C ) 皆未過網且未具攻擊助跑概念(D )  
小組比賽 |  1 |  10% |  分組排球競賽 |   
配分比率加總 |  100% |  |   
