...
#  12/8 W15 選舉前的政治人物專書出版：選舉語言與品牌塑造
  1. 政治人物的書是敘事？宣傳？還是修辭工具？
  2. P18 課堂參與：角色扮演，分組模擬政治人物出版書籍的策劃會議，討論如何撰寫書名，章節安排和行銷策略。


# 12/15 W16 Project Presentation 
...
##  評量工具與策略、評分標準成效Evaluation Criteria
  * 30%課堂參與 (P)：修課學生事先完成課前作業，並需準時出席課堂和加入專書報告的討論。
  * 20% 個人閱讀分享5分鐘：  
1) 請採用pecha kucha報告方式(20秒一張投影片，5分鐘共15張投影片)  
2) 簡介一本最近在讀/聽的書/節目，將從第七週開始在課堂上陸續用簡報報告。。  
3) 評分標準：  
簡報美學(30%)：簡報視覺呈現、排版、設計的精美程度。  
肢體與口語表達(30%)：口語表達流暢程度、肢體語言、講者整體表現。  
內容(40%)  
4) 請上傳到moodle作業區, 嚴禁在課堂網頁登入個人canvas, email, 以節省時間。
  * 20% 專書報告(R) +分組討論課帶領  
1) 各組(每組人數依修課人數而定) 針對每週指定閱讀(R)進行報告20-25分鐘。內容包括作者介紹，內容，相關書評。  
2) 並準備4-5個討論問題，帶領接下來30分鐘的小組討論。問題設計以開放式問題為主，避免Yes/no 問題。  
3) 評分標準：書籍內容(40%)，討論問題設計(30%)和帶領討論氣氛(30%)。  
4) 請繳交小組分工表
  * 30% 期末個人/分組報告：我的xx書單/影片/歌單  
1) 自選一個主題，如healing, feeling blue，heartbroken, love, mixed feeling…..，收集至少10本書/歌/電影/podcast，針對該主題撰寫前言(至少500字)，說明選書/片/歌的考量，並針對每一個推薦項目，撰寫至少100字簡介並選錄句子金句對白等。  
2) 上述字數是適用於個人報告，若是採小組報告，字數和件數乘於人數。如2人1組，前言(+分類)至少500x2=1000字，至少10x2=20件，各推薦項目簡介至少100字則維持不變。  
3) 10% 第15-16週：口頭報告  
4) 20% 第16週：書面報告繳交。書面報告形式請想像是一份放在誠品書店樓梯間供人拿取的宣傳手冊，請在版面設計和吸睛程度上多加考慮。
