...
平時作業 10%, 單元測驗 10%, 議題討論 10%, EXCEL專案實作 20%, 
ACCESS專案實作 20%, EXCEL上機考試15%, ACCESS上機考試 15%。
##  指定/參考書目Textbook & References
面授及遠距教學教材會以錄影、檔案及教學網頁等方式置於網站上。
####  已申請之圖書館指定參考書目  圖書館指定參考書查詢 |相關處理要點
維護智慧財產權，務必使用正版書籍。 Respect Copyright.
##  本課程可否使用生成式AI工具Course Policies on the Use of Generative AI Tools
有條件開放使用:專案發想及資料收集輔助可，其他含議題討論、作業及考試等不可。 Conditional Permitted to Use 
###  課程相關連結Course Related Links
```
Moodle教學平台  https://moodle.nccu.edu.tw/
```
