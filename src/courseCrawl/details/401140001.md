...
## **第十三週：新聞傳播與媒體識讀**
*課堂活動：辯論「媒體識讀能力是構成良好的新聞環境的要件」
### 指定閱讀
  * 劉慧雯（2022）。〈第一章：批判的媒體素養：數位在地人的世代〉，王維菁、林玉鵬、王俐容（編）《AI時代的數位傳播素養教育》，頁21-39。台北：五南。
...
## **第十四週：新聞傳播與媒體倫理**
### 指定閱讀
  * 蘇蘅（2018）。〈新聞專業的新視野：媒體實踐與台灣的問題〉，《傳播文化》，17，153-187。
  * 蘇蘅（2015）。〈新聞倫理教育的困境：大學生倫理觀與媒體表現評價的影響〉，《傳播與社會學刊》，33，153-187。
...
### 參考閱讀
  * 林宇玲（2015）。〈制度化公民新聞學的新聞品質與倫理問題之初探：以台灣四家線上新聞組織的公民平台為例〉，《傳播與社會學刊》，33，189–223。
  * 徐孟延、蘇蘅（2015）。〈多媒介時代的新聞與倫理：台灣民眾新聞使用、媒介信任與倫理觀的關聯研究〉，《傳播與社會學刊》，33，225-254。


  * 鄭宇君（2009）。《新聞專業中的真實性：一種倫理主體的探究模式》。政治大學新聞所博士論文。
...
##  評量工具與策略、評分標準成效Evaluation Criteria
  * **課堂討論(30%)：**
    * **報告(20%)：** 除了第一週之外，每週兩或三位同學針對當週的指定閱讀進行20分鐘的報告──摘要指定閱讀的重點，提出兩到三個問題，帶領大家討論。
    * **評論(10%)：** 每位同學除了負責一週的指定閱讀之外，還需要擔任另外一週的評論人──針對報告者的表達能力、摘要內容的邏輯、正確性與完整度等進行評論。
  * **期中報告(35%)：** 一篇3,000-4,000字[1]的論文，題目自訂，需要和「數位時代下的新聞生產、消費或傳播」相關，也需要使用到至少四篇本課程的指定或參考書目。於第七週（10/14）和第八週（10/21）的課堂上進行5-10分鐘的口頭報告，蒐集研究寫作建議，並且在10/31的23:59之前，將論文上傳至Moodle。
