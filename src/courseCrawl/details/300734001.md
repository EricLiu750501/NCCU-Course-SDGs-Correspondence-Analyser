...
##  評量工具與策略、評分標準成效Evaluation Criteria
  * Midterm Hackathon (20%)
  * Final Hackathon – Group Presentation (50%) 
  * Class participation (30%): Students are expected to attend classes. Those who have three absences will fail the class. Students also need to actively participate in class discussions, complete lab assignments, and contribute to group work. Students get one point when making a relevant comment during the discussion. Relevant comments are those that focus on significant issues that bear on the topic in question. The minimum requirement for each student is five points.


##  指定/參考書目Textbook & References
Will be distributed before class
...
office hours by appointment, 商院1214
