...
本課程的評量標準主要包括下述：
1. 案例報告(20%)：學期中每位同學將針對所分配到美國案例，作判決摘要，並進行課堂報告。
2. 實例研習(50%)：整學期將模擬法庭（moot court），貫穿課堂不同主題，並檢視同學能否將所學知識，運用於實例當中。
3. 商業個案(30%)：學期末將進行商業個案討論，以將所習得競爭法知識應用於公司營運決策中。每個案均會設計作業問題。
4. 課堂參與(10%)：同學每週的課堂發言或參與均會納入計分，並於學期末納入考評。
5. 有事無法出席課堂者，請記得請假。
##  指定/參考書目Textbook & References
# Textbook
  1. Herbert Hovenkamp, Principles of Antitrust (Concise Hornbook Series), 2nd edition, West Academic Publishing (2020).


# Reference Book
  1. Thomas Weck & Masako Wakui, Comparative Competition Law, World Scientific (2023).
  2. Gary Myers, The Intersection of Antitrust and Intellectual Property (American Casebook Series), 2nd edition, West Academic Publishing (2017).
