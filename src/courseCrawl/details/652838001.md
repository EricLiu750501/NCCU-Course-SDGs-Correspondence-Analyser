...
A final paper has to be submitted in the end of the semester on a group base. It is preferred that this final paper derives from the students’ presentation, and incorporates their own responses, and their colleagues’ comments. Papers should be printed on A4 size papers. Ideally, a final paper written in English should be around 3500-5,000 words, the due day of final papers is December**23rd., 2025**.
...
Hours input for learning on preview and review : 2 hours
**10月14日****Preparation Day: Group Discussion for TA Session (1)**
**10月21日** TA Session (1)
...
Monday 1500 ~ 17: 00 (by appointment only)
