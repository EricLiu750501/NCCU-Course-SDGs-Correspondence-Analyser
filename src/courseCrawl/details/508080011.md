...
**Attendance: 10%**  
Regular _attendance is required_.
**In-Class Performance and Assignments: 30%**  
Students _upload AI-assisted dialogues_ and _participate in speaking activities_.
**Midterm Exam: 30%**
**Final Exam: 30%**
∗∗∗
**Devam: %10**  
Derse düzenli katılım gereklidir.
**Sınıf İçi Performans ve Ödevler: %30**  
Öğrenciler AI destekli diyalogları yükler ve konuşma etkinliklerine katılır.
**Ara Sınav: %30**
**Final Sınavı: %30**
##  指定/參考書目Textbook & References
**References:** Lecture notes prepared by the instructor.
**Textbook:** 徐漢陽 (Erhan Taşbaş), 2025, _⼟⽿其語 聽⼒與會話•A2-B1 A2-B1 Düzeyler için Türkçe Dinleme ve Konuşma_ , Ruilan International 瑞蘭國際, Taipei.
∗∗∗
**Kaynaklar:** Öğretim üyesi tarafından hazırlanan ders notları
**Ders kitabı:** 徐漢陽 (Erhan Taşbaş), 2025, _⼟⽿其語 聽⼒與會話•A2-B1 A2-B1 Düzeyler için Türkçe Dinleme ve Konuşma_ , Ruilan International 瑞蘭國際, Taipei.
