...
**配分項目 Items** |  **次數 Times** |  **配分比率 Percentage** |  **配分標準說明** **Grading Description** |  **備註** **Note**  
---|---|---|---|---  
出席 |  16 |  30% |  無故曠課3次(含)期末扣考 事、病、喪假需隔週檢附證明 |   
基本技能測驗 |  1 |  10% |  高手傳接球 |  40整(A)+ 35~39下(A) 30~34下(A-) 25~29下(B+) 20~24下(B) 15~19下(B-) 10~14下(C+) 9以下(C )  
基本技能測驗 |  1 |  5% |  低手傳接球 |  40整(A)+ 35~39下(A) 30~34下(A-) 25~29下(B+) 20~24下(B) 15~19下(B-) 10~14下(C+) 9以下(C )  
期中考 |  1 |  20% |  攻防扣接 |  5次整(A+) 4次(A) 3次(B+) 2次(B) 1次(C +)  
學期考 |  1 |  25% |  發球技能測驗 |  九宮格(依照前、中、後排位置不同給予不同配分標準)  
小組比賽 |  1 |  10% |  分組排球競賽 |   
配分比率加總 |  100% |  |   
*缺席須事前或事後向授課教師請假，缺席3次以上皆未向授課教師請假，期末測驗扣考，請自行考慮於期中棄修
...
**每堂課堂前10分鐘或課後10分鐘(授課地點)，關於排球運動技戰術或學術交流。**
