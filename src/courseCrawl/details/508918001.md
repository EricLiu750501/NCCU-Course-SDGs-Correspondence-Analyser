...
Ders devam: % 10 (devam) 出席情形
Sınıf içi performans: %40 (ders katılım, performans) 課堂表現
Ara sınav: % 20 (ara sınav sonucu) 期中考
Final Sınavı: % 30 (final sınavı sonucu) 期末考  
