...
（一）評量工具與策略
等第╱項目 |  閱讀能力30% |  表達能力30% |  書寫格式10% |  反思能力**30** %  
---|---|---|---|---  
優A：90-100 |  能詳實閱讀指定讀物，完整掌讀物要旨 |  文字清楚、簡潔，論述具邏輯性 |  能清楚掌握格式 |  能反思指定讀物的的特點與限制  
佳B：70-89 |  能詳實閱讀讀物 |  文字清楚、簡潔 |  能大體掌握格式 |  能反思指定讀物的的特點  
普通C：60-69 |  充分閱讀指定讀物 |  文字清楚 |  能部分掌握格式 |  能反思指定讀物的部分特點  
待改進D：60以下 |  未閱讀指定讀物 |  文字不清楚 |  無法掌握格式 |  未能能反思指定讀物的特點  
...
計畫書請包括：(1)題目、(2)研究動機、(3)研究回顧、(4)研究方法、(5)研究材料、(6)章節安排、(7)可能遭遇的困難與解決方式、(8)預期成果與對學界的貢獻、(9)徵引書目（含傳統文獻與當代研究）。
  1. 期末報告：由研究計畫發展而來，以**8,000** 字（含正文、註腳）為原則。書寫格式請參考《政大歷史學報》撰稿格式。**2025****年****12****月****31****日之前** 以word檔上傳到Moodle作業繳交區。
  2. 良好的學習態度與積極的課堂參與，乃本課程基本要求。請假請依照規定，進入**iNCCU****學生請假系統** ，提交假單與證明文件（生理假、心理假除外）。學期中無故缺課三次（含）者，學期成績不計。


上課表現與出席率佔學期總成績**60%** 。研究計畫與期末書面報告佔**40%** 。
