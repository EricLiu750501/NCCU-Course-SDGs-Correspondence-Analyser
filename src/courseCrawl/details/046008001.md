...
課堂討論與出席 10%、App 平時作業 25%、提案報告 20%、專案期末報告 40%、同儕評量 5%。
##  指定/參考書目Textbook & References
  1. Rowe, Peter G., Design Thinking, Cambridge, MA: MIT Press, 1987.
  2. Stanford d.School, An Introduction to Design Thinking.
  3. Tim Brown, Design Thinking, Harvard Business Review,86(6):84-92, 2008.
  4. MIT App Inventor 2, https://ai2.appinventor.mit.edu/.
  5. Michael Lewrick, Patrick Link, Larry Leifer, The Design Thinking Toolbox: A Guide to Mastering the Most Popular and Valuable Innovation Methods, Wiley, 2020.
  6. Project Management Institute, A Guide to the Project Management Body of Knowledge (PMBOK Guide) and The Standard for Project Management, Seventh Edition, 2021.
...
有條件開放使用:需說明使用的範疇 Conditional Permitted to Use 
