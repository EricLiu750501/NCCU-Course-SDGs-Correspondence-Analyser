...
**15** |  **Công Nghệ** **技術** **Technology** | 
  ...
  * 針對「**技術****4.0** 」的個人想法及回答相關問題 Personal opinions and answer to questions related to “**Technology 4.0** ”
...
學生需於課前將詞彙記熟，進行文法與閱讀複習，以便於課堂上進行 討論與練習。課堂作業繳交將以寄送 Moodle方式交予講師。在整個學期中，持續與積極的參與對於成功的學習是不可或缺的。 因此，學生未經講師事先許可不得擅自缺席。若無故缺勤，總成績會被扣分。缺席四次以上的學生不能參加期末考試。  
Students are responsible for memorizing vocabulary, reviewing grammar, and reading materials before class in order to reserve valuable in-class time for oral practice. All assignments are submitted in Moodle prior to the deadlines. Consistent and constructive participation throughout the semester is essential to the success of learning. Therefore, attendance is mandatory without the advance permission of the instructor. The unexcused absences will result in a final grade reduction. Students who have absences over four times will not be allowed to take the final exam.
最終成績將依以下五個標準計算：  
The final grades are determined by 5 parts as follows:  
1. 出席率與參與度 Attendance and participation: 20%  
2. 回家作業(閱讀與寫作) Homework (reading and writing): 20%
3. 小考測驗 Quiz test ： (10%)  
4. 期中考試(聽，讀，寫) Midterm exam (Listening- Reading-Writing): 25 %  
5. 總結報告 Final report: 25%
