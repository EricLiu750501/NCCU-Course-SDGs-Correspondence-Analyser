...
Term Paper: 40%
Students are expected to read and prepare 2–3 core journal articles per week from journals such as:
  * _Academy of Management Journal (AMJ)_
  * _Academy of Management Review (AMR)_
  * _Administrative Science Quarterly (ASQ)_
  * _Organization Science (OS)_
  * _Strategic Management Journal (SMJ)_
  * _Journal of Management (JoM)_
  * _Journal of Management Studies (JMSt)_
  * _Journal of Business Venturing (JBV)_
  * _Entrepreneurship Theory & Practice (ETP)_


Each student is required to prepare and present a referee report (in PowerPoint format) of the assigned paper(s) every week. 
In the term paper, students are required to review relevant literature, develop testable hypotheses/propositions, and explain the methods through which they test the hypotheses.
