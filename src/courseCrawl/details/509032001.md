...
(a) 10% (oral) participation and rarely written homework  
(b) 20%: 2 Tests/Quizzes (ca. 10 Minuten)  
(c) 35%: the mid term /Zwischenprüfung (oral/mündlich)  
(d) 35%: the Final exam/Abschlussprüfung (oral/mündlich)
##  指定/參考書目Textbook & References
Just like in the semester before, the latest (augmented) new version of the textbook “Aspekte neu Mittelstufe Deutsch B1 plus” (Langenscheidt & Klett Verlag, ISBN 978-3-12-605016-6) will be required for the class. The uploading of the respective App "Klett Augmented" that accompanies the textbook is highly recommended for practice outside of classroom hours. 
Furthermore, every student will need a dictionary. Additional copied material for the next class session may be distributed by the teacher; please look into your email box 1 day before you come to class. 
B1 Zertifikat Deutschprüfung für Jugendliche und Erwachsene. Modellsatz Erwachsene. Hrg. vom Goethe Institut, Univ. Freiburg/Schweiz 2013 (2. Auflage 2015). 此資料已經上傳至E moodle平台，請自行多加使用。
