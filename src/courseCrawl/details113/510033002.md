...
#####  Course Name: Basic Indonesian Conversation
  ...
  * 科目代碼：510033002 Course No.510033002
#### 修別：必
...
課程資料Course Details
  ...
  * 先修科目：[ 初級印尼語會話(單學期)(修習且及格)]Prerequisite([ Basic Indonesian Conversation])
...
Indonesian language proficiency level:
  * Be able to acquire Elementary level (A2)
...
課程名稱 Course Name |  Elementary Indonesian Conversation II |  |   
...
先修科目 Prerequisite(s) |  Complete Elementary Indonesian Conversation I |  |   
上課時間 Course Time |  Monday (8am-10am) Friday (10am-12pm) Ji Tao 340402 |  |   
|  Course Characteristics   
◎Score Description:  
1 indicates weakest relevance, and 5 indicates strongest relevance. Select the corresponding score for each course characteristic. Please select "1" for zero or low relevance. |   
---|---  
|   
|   
|   
|   
|   
|  Humanity and Care Course |  Relevance Score: 〇1 〇2〇3 〇4 √5  
---|---  
Interdisciplinary Course |  Relevance Score: 〇1 〇2 〇3〇4 √5  
Social Engagement Course |  Relevance Score: 〇1〇2 〇3 〇4 √5  
...
1 |  Course Introduction + Review Basic Conversation I | 
  1. Course introduction
  2. Review Basic Conversation I
|  In-class activities: 
  1. Course Introduction
...
|  4 hours |  6 hours  
2 |  Likes and Dislikes (Food) | 
  1. How to ask about likes and dislikes (food) 
  2. How to describe about food (taste, where to buy, …)
|  In-class activities: 
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
3 |  Describing what people are doing | 
  1. Describing what people are doing (now, where, with whom, …)
|  In-class activities: 
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
4 |  Things in the classroom and university  | 
  1. How to describe locations (in a university and a classroom)
  2. How to ask where something is
  3. How to ask for a description of something
  4. Describing campus life
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
5 |  Talking about building and location | 
  1. How to ask about location (public places)
  2. How to ask if something is located nearby
  3. How to describe a location (buildings in the city)
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
6 |  Showing Directions | 
  1. How to ask about distance
...
|  4 hours |  6 hours  
7 |  Family | 
  1. Anggota keluarga (family members): Bapak (Father), Ibu (Mother), etc
  2. Verbs: kegiatan sehari-hari (daily activities of the family members)
...
9 |  Describing appearance | 
  1. Part of the bodies; Colors; Adjectives: tinggi (tall), pendek (short), cantik (beautiful), tampan (handsome)
  2. How to describe physical appearance
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
10 |  Describing personality  | 
  1. Adjectives: personality traits – sabar (patient), ramah (friendly), jujur (honest), malas (lazy), etc
  2. How to describe personality
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
|  4 hours |  6 hours  
11 |  Go for Shopping | 
  1. Things in the store; Harga (price): ratusan (hundred), ribuan (thousand), jutaan (million)
  2. How to bargain
  3. How to ask about the price
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
12 |  Go to restaurants | 
  1. Name of food and drinks
  2. How to order food (dine in & online/by phone)
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
13 |  Aspirations and Dreams  | 
  1. How to describe the jobs
  2. How to express desires or aspirations 
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
14 |  Biography/ Life history | 
  1. Telling chronological events in life
|  In-class activities: 
  1. In class-quiz: vocabulary
  2. Vocabulary exercises
  3. Pronunciation Exercises
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
15 |  Giving Opinion and Suggestion | 
  1. How to asks for opinions
  2. How to give opinions
  3. How to ask for suggestions
...
Homework: 
  ...
  2. Practice pronunciation
|  4 hours |  6 hours  
16 |  Review |  Review: Preparation for final exam |  In-class activities: 
  1. In class-quiz: vocabulary
  2. Review the materials
Homework: 
  1. Prepare for mid term
|  4 hours |  6 hours  
17 |  Final Exam |  Individual oral test or role play in groups/in pairs |  |  4 hours |  6 hours  
