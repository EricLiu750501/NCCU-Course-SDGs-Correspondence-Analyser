...
#####  Course Name: Planning Practice (II) (lab)
  ...
  * 科目代碼：207957002 Course No.207957002
#### 修別：必
...
課程資料Course Details
  ...
  * 先修科目：[ 規劃實務（二）實習(單學期)(修習且及格)]Prerequisite([ Planning Practice (II) (lab)])
...
2 | 問卷調查與現勘 | 
  ...
  * 問卷結果分析
|  問卷調查與分析 |  4.0 |  6.0  
3 | 問卷調查結果簡報 |  鄉村規劃案例分享 問卷調查結果簡報 |  替選方案研擬 |  4.0 |  6.0  
4 | 3D模型製作介紹 | 
  * 社區總體營造
  * 3D模型製作介紹
|  替選方案研擬 |  4.0 |  6.0  
...
11 | 3D模型製作 | 
  ...
  * 3D模型製作
|  完成模型、海報 |  4.0 |  6.0  
12 | 期中報告 |  期中報告 |  |  4.0 |  6.0  
13 | 實習聯展 | 實習聯展 |  實習聯展 |  4.0 |  6.0  
14 | 校內佈展 | 
  * 校慶/校慶運動會(停課)
  * 校內佈展
|  行大二樓海報電腦 |  4.0 |  6.0  
