...
#####  Course Name: Information Systems Project
  ...
  * 科目代碼：306016002 Course No.306016002
#### 修別：必
...
課程資料Course Details
  ...
  * 先修科目：[ 資訊系統專案設計(單學期)(修習且及格)]Prerequisite([ Information Systems Project])
  * 上課時間：六EFG Session: sat18-21
##  課程簡介Course Description
Students work in teams on the selected projects and develop a system that can fulfill the desired functions. Before implementing the system, system analysis method and design methods or tools should be applied. Detail specification and design should be properly prepared. Documentation should be maintained properly as well. The code of the system should be upload to a public repository. The code tracking system should be used as well.
The topic may include security, data analysis, and fintech. Students should be familiar with some development tool or language, such as HTML, CSS, Python, database, machine learning algorithm, etc.
Tools:  
- Web framework: Python web framework (model/view/control), database system, frontend/backend  
- Message Broker: open source message broker  
