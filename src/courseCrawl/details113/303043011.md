...
課程資料Course Details
  ...
  * 先修科目：[ 初級會計學（一）(單學期)(修習且及格)] 及 [ 初級會計學（二）(單學期)(修習且及格)] 及 [ 審計學（一）(單學期)(修習且及格)]Prerequisite([] AND [] AND [])
...
6 |  未開課  
7 |  114年4月2日校際活動週(停課)  
8 |  一 |  ACL基本介紹 |  審計與ACL實務 關聯影響 基本資料結構介紹 |  ACL概論及資料匯入應用  
9 |  一 |  ACL基本運用 |  基本功能介紹與運用 | 
  1. Table layout
  2. 分析功能及表達式(基本運算、審計實驗分析、統計分析)
  3. 資料處理(資料輸出、資料整合、其他)
  4. Sample(MUS抽樣)
10 |  一 |  ACL實際操作 (一) |  實際案例操作(一) | 
  1. 綜合練習(收入測試及試算表驗證)
  2. script錄製功能
  3. 實務庫齡觀念介紹
11 |  一 |  ACL實際操作 (二) |  實際案例操作(二) | 
  1. 實務庫齡觀念介紹延伸
  2. 庫齡計算操作
12 |  一 |  成果檢驗 (一) |  學習成果檢驗 |  同學分享&講師回饋  
13 |  二 |  ACL基本介紹 |  審計與ACL實務 關聯影響 基本資料結構介紹 |  ACL概論及資料匯入應用  
14 |  二 |  ACL基本運用 |  基本功能介紹與運用 | 
  1. Table layout
  2. 分析功能及表達式(基本運算、審計實驗分析、統計分析)
  3. 資料處理(資料輸出、資料整合、其他)
  4. Sample(MUS抽樣)
15 |  二 |  ACL實際操作 (一) |  實際案例操作(一) | 
  1. 綜合練習(收入測試及試算表驗證)
  2. script錄製功能
  3. 實務庫齡觀念介紹
16 |  二 |  ACL實際操作 (二) |  實際案例操作(二) | 
  1. 實務庫齡觀念介紹延伸
  2. 庫齡計算操作
17 |  二 |  成果檢驗 (一) |  學習成果檢驗 |  同學分享&講師回饋  
18 |  一 二 |  實務課程分享 | 
  1. Script案例分享
  2. 電腦審計介紹
  3. 實務案例分享
