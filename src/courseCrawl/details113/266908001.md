...
# 教學大綱 Syllabus
##  科目名稱：因果推論與資料科學在經濟學的應用
#####  Course Name: Causal Inference and Data Science in Economics
  * 學年學期：113-2 Spring Semester, 2025 
  * 科目代碼：266908001 Course No.266908001
#### 修別：選
...
課程資料Course Details
  ...
  * 授課老師：楊子霆 Instructor: YANG TZU TING 
...
##  課程目標與學習成效Course Objectives & Learning Outcomes 
  1. Be able to understand and use recent advances in applied econometrics (causal inference and data science)
  2. Be able to implement good empirical research
  3. Be able to evaluate empirical studies
  4. Be familiar with the techniques and tricks of data management and visualization
  5. Have a good start of your Master/Ph.D. thesis
...
Please see course website: https://causaldatalab.wordpress.com/2023/02/01/causal-inference-and-data-science-in-economics-spring-2023/
####  其他： Others:
