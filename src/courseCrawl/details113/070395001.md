...
課程資料Course Details
  ...
  * 先修科目：[ 人工智慧方法與工具(單學期)(修習且及格)]Prerequisite([ Artificial Intelligence : Methods and Tools])
  * 上課時間： Session: 
...
欲加入研究學生 於寒假至加退選週結束期間 將line ID mail給老師 lynchen@nccu.edu.tw 
需要擋修單及加簽單同學mail電子檔 給老師 
PS: 最上面問卷:分組表單 尚未有組同學可填寫"待定 " 由老師於加退選週後依專長背景協助分至合適組別
2.吳致勳老師，固定每週二D56 Meeting，電算中心智慧教室(140011)，實務專題聚焦SDGs永續議題，並導入設計思考觀念與實作，欲請吳致勳老師指導或需加簽的同學請寫信與老師聯繫，信箱：20031214@nccu.edu.tw
3.吳怡潔老師，討論時間固定於每週一D56 Meeting，地點於電算中心智慧教室(140011)；教材及作業另開teams群組上傳檔案；信箱：matywu@nccu.edu.tw
...
13 |  專題改良 |  系統改良 |  小組討論  
14 |  專題測試 |  系統測試 |  小組討論  
15 |  專題反思 與未來展望 |  未來研究方向 | 小組討論  
16 |  專題反思 與未來展望 |  Innofest海報聯展 |  期末展示  
17 |  彈性學習 |  小組專題製作經驗 |  數位平台分享  
