...
本課程採取翻轉式教學，以學習者為主體，並於期末舉行期末考試檢視學習成效。  
上課方式強調學生主動參與小組的合作學習，選定課題並隨堂口頭報告。課堂出席、參與討論、爭取發言機會、搜尋整理並上傳預讀資料，等均列入平常成績。  
課堂參與10％、小論文*2 40％、分組口頭報告20％、期末考30%。
